...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action='<c:url value="/Home/Login"></c:url>' method="post">
			...
			<input type="text" placeholder="Name" name="nameS" value="${nameS}"/>
			<input type="email" placeholder="Email" name="emailS" value="${emailS}"/>
			<input type="password" placeholder="Password" name="passwordS" value="${email}"/>
